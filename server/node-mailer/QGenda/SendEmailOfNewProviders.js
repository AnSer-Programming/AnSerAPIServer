...
const sendEmail = (data) => {
  ...
  async function main() {
    const info = await transporter.sendMail({
      ...
      subject: "QGenda New Provider Report", // Subject line
      text: `Hello,\n\nQGenda API has new providers, please review the attached document.\n\nThank you,\nAnSer`, // plain text body
      html: `<p>Hello,</p>
      <p>QGenda API has new providers, please review the attached document.</p>
      <p>Thank you,<br />
      AnSer</p>`, // html body
